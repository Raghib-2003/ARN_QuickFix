...
<body>
  ...
  <!-- Navbar Start -->
    ...
    <!-- Search Start -->
 <!-- Expert Search + Search Results Start -->
<div class="container-fluid pt-5">

  <!-- SEARCH HEADER + FILTER -->
  <div class="container">
    <div class="text-center mx-auto mb-5" style="max-width: 650px;">
      <span class="text-primary text-uppercase fw-semibold" style="letter-spacing:2px;">
        Expert Search
      </span>
      <h1 class="display-5 mt-2 mb-3">Find an Elevator Specialist</h1>
      <p class="text-muted mb-0">
        Connect with certified elevator engineers for installation, maintenance, modernization, and safety inspection.
      </p>
    </div>

    <div class="mx-auto bg-light rounded p-4 shadow-sm mb-5" style="max-width: 720px;">
      <div class="row g-3">
        <div class="col-md-4">
          <select class="form-select border-0 bg-white" style="height: 55px;">
        ...
        <div class="col-md-5">
          <input type="text"
                 ...
                 placeholder="Search by expertise or keyword"
                 style="height: 55px;">
        </div>

        <div class="col-md-3 d-grid">
          <button class="btn btn-primary fw-semibold" style="height: 55px;">
            Search
          </button>
        </div>
      </div>
  ...
  <div class="container pb-5">
    <div class="row g-4">
          ...
          <div class="row g-0 h-100">
            <div class="col-sm-5">
              <img src="img/14.jpg"
                   ...
                   alt="Senior Elevator Engineer">
            </div>
            <div class="col-sm-7 d-flex flex-column">
              <div class="p-4">
                <h4 class="mb-1">Engr. Mahmud Hasan</h4>
                <p class="text-primary fw-semibold mb-2">Senior Elevator Engineer</p>
                <p class="text-muted small mb-0">
                  12+ years experience in high-rise elevator installation, AMC, and modernization projects.
                </p>
              </div>

              <div class="mt-auto border-top p-3 d-flex justify-content-between align-items-center">
                <small class="text-muted">
                  <i class="fa fa-location-dot me-1"></i> Dhaka
                </small>
                <div>
                  <a class="btn btn-sm btn-outline-primary rounded-circle me-2" href="#">
                    <i class="fab fa-linkedin-in"></i>
                  </a>
                  <a class="btn btn-sm btn-outline-primary rounded-circle" href="#">
          ...
          <div class="row g-0 h-100">
            <div class="col-sm-5">
              <img src="img/13.jpg"
                   class="img-fluid h-100 w-100"
                   style="object-fit: cover;"
                   alt="Maintenance Specialist">
            </div>
            <div class="col-sm-7 d-flex flex-column">
              <div class="p-4">
                <h4 class="mb-1">Engr. Farhan Ahmed</h4>
                <p class="text-primary fw-semibold mb-2">Maintenance & AMC Specialist</p>
                <p class="text-muted small mb-0">
                  Expert in preventive maintenance, emergency response, and elevator safety compliance.
                </p>
              </div>
          ...
          <div class="row g-0 h-100">
            <div class="col-sm-5">
              <img src="img/12.webp"
                   class="img-fluid h-100 w-100"
                   style="object-fit: cover;"
                   alt="Emergency Technician">
            </div>
            <div class="col-sm-7 d-flex flex-column">
              <div class="p-4">
                <h4 class="mb-1">Engr. Rafiul Islam</h4>
                <p class="text-primary fw-semibold mb-2">Emergency Response Technician</p>
                <p class="text-muted small mb-0">
                  Specialist in breakdown recovery, rescue operations, and quick fault diagnosis 24/7.
                </p>
              </div>
          ...
          <div class="row g-0 h-100">
            <div class="col-sm-5">
              <img src="img/11.jpg"
                   class="img-fluid h-100 w-100"
                   style="object-fit: cover;"
                   alt="Modernization Engineer">
            </div>
            <div class="col-sm-7 d-flex flex-column">
              <div class="p-4">
                <h4 class="mb-1">Engr. Shakib Hossain</h4>
                <p class="text-primary fw-semibold mb-2">Modernization Engineer</p>
                <p class="text-muted small mb-0">
                  Elevator upgrades, controller replacements, ride comfort tuning, and energy-efficient solutions.
                </p>
              </div>
      ...
      <div class="col-12 text-center mt-4">
        <button class="btn btn-outline-primary px-5 py-3 rounded-pill fw-semibold">
          Load More Experts
        </button>
      </div>
...
<!-- Expert Search + Search Results End -->
    <!-- Search Result End -->
