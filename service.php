 ...
 <div class="container-fluid py-5">
  <div class="container">
    <div class="text-center mx-auto mb-5" style="max-width: 600px;">
      ...
      <p class="mb-0">
        From installations to emergency repairs, we deliver safe, smooth, and reliable vertical mobility for every building.
      </p>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Complete lift installation for residential and commercial projects—planned, precise, and on-time.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="contact.html" title="Get a Quote">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Regular checks, tuning, and servicing to reduce breakdowns and extend elevator life.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="service.html" title="View Maintenance Plans">
            <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Fast response for shutdowns, entrapments, and urgent faults—anytime you need us.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="contact.html" title="Call Support">
            <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Upgrade controllers, doors, and interiors for better safety, smooth ride, and efficiency.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="service.html" title="Explore Upgrades">
            <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Detailed inspection, safety checks, and performance testing to meet standards and compliance.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="service.html" title="Book Inspection">
            <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center p-4">
          ...
          <p class="m-0">Quick fault diagnosis and genuine spare replacement to restore operation with minimal downtime.</p>
          <a class="btn btn-lg btn-primary rounded-pill mt-3" href="contact.html" title="Request Service">
            <i class="bi bi-arrow-right"></i>
          </a>
        </div>
      </div>
        ...
        <div class="owl-carousel testimonial-carousel">
          ...
          <div class="testimonial-item text-center">
            <div class="position-relative mb-5">
              <img class="img-fluid rounded-circle mx-auto" src="img/testimonial-1.jpg" alt="Client Review">
              <div
            ...
            <p class="fs-4 fw-normal">
              “Sonic Elevator provided excellent maintenance service. Their technicians were professional,
              punctual, and our elevator performance improved immediately.”
            </p>
          ...
          <div class="testimonial-item text-center">
            <div class="position-relative mb-5">
              <img class="img-fluid rounded-circle mx-auto" src="img/testimonial-2.jpg" alt="Client Review">
              <div
                class="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white rounded-circle"
                style="width: 60px; height: 60px;">
                <i class="fa fa-quote-left fa-2x text-primary"></i>
            ...
            <p class="fs-4 fw-normal">
              “We upgraded our elevator system with Sonic Elevator. The modernization was smooth,
              and ride comfort is much better now.”
            </p>
          ...
          <div class="testimonial-item text-center">
            <div class="position-relative mb-5">
              <img class="img-fluid rounded-circle mx-auto" src="img/testimonial-3.jpg" alt="Client Review">
              <div
                class="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white rounded-circle"
                style="width: 60px; height: 60px;">
                <i class="fa fa-quote-left fa-2x text-primary"></i>
            ...
            <p class="fs-4 fw-normal">
              “Their 24/7 emergency response is outstanding. Our elevator breakdown was resolved quickly
